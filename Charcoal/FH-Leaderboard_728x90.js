...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.4,6.9).lineTo(-1.4,-6.9).lineTo(1.5,-6.9).lineTo(1.5,6.9).closePath();
	...
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.5,7).lineTo(-1.5,-2.5).lineTo(1.4,-2.5).lineTo(1.4,7).closePath().moveTo(-1.2,-4.1).curveTo(-1.7,-4.7,-1.7,-5.4).curveTo(-1.7,-6,-1.2,-6.5).curveTo(-0.7,-7,-0,-7).curveTo(0.7,-7,1.2,-6.5).curveTo(1.7,-6,1.7,-5.4).curveTo(1.7,-4.7,1.2,-4.1).curveTo(0.7,-3.7,-0,-3.7).curveTo(-0.7,-3.7,-1.2,-4.1).closePath();
	this.shape_2.setTransform(47.075,10.95);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.7,6.7).lineTo(2.7,1.4).lineTo(-2.7,1.4).lineTo(-2.7,6.7).lineTo(-5.7,6.7).lineTo(-5.7,-6.7).lineTo(-2.7,-6.7).lineTo(-2.7,-1.5).lineTo(2.7,-1.5).lineTo(2.7,-6.7).lineTo(5.7,-6.7).lineTo(5.7,6.7).closePath();
	...
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_5.setTransform(9.525,13.225);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3,4.8).lineTo(-3,-4.7).lineTo(-0.2,-4.7).lineTo(-0.2,-3.4).curveTo(0.5,-4.8,2.3,-4.8).lineTo(3,-4.7).lineTo(3,-1.8).lineTo(2.1,-1.9).curveTo(1.2,-1.9,0.6,-1.3).curveTo(-0.1,-0.7,-0.1,0.7).lineTo(-0.1,4.8).closePath();
	this.shape_6.setTransform(0.8,13.175);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-0.6,5.4).curveTo(-1.5,4.6,-1.5,3.2).lineTo(-1.5,-0.9).lineTo(-3.2,-0.9).lineTo(-3.2,-3.4).lineTo(-2.7,-3.4).curveTo(-1.3,-3.4,-1.3,-5).lineTo(-1.3,-6.2).lineTo(1.4,-6.2).lineTo(1.4,-3.4).lineTo(3.2,-3.4).lineTo(3.2,-0.9).lineTo(1.4,-0.9).lineTo(1.4,2.6).curveTo(1.4,3.6,2.4,3.6).lineTo(3.2,3.5).lineTo(3.2,5.9).curveTo(2.6,6.2,1.6,6.2).curveTo(0.1,6.2,-0.6,5.4).closePath();
	this.shape_7.setTransform(-7.3,11.925);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.4,5.7).curveTo(-4.6,4.7,-4.9,3.4).lineTo(-2.3,2.6).curveTo(-2.2,3.4,-1.6,3.8).curveTo(-1.1,4.2,-0.3,4.3).curveTo(2,4.3,2,1.8).lineTo(2,1.4).curveTo(1.3,2.4,-0.5,2.4).curveTo(-2.4,2.5,-3.6,1.2).curveTo(-4.9,-0.2,-4.9,-2.1).curveTo(-4.9,-4.1,-3.6,-5.4).curveTo(-2.4,-6.7,-0.5,-6.7).curveTo(1.5,-6.7,2.1,-5.6).lineTo(2.1,-6.6).lineTo(4.9,-6.6).lineTo(4.9,1.6).curveTo(4.9,3.9,3.7,5.2).curveTo(2.4,6.7,-0.2,6.8).curveTo(-2.1,6.8,-3.4,5.7).closePath().moveTo(-1.4,-3.7).curveTo(-2,-3.1,-2,-2.1).curveTo(-2,-1.2,-1.4,-0.6).curveTo(-0.8,-0,0.1,-0.1).curveTo(0.9,-0,1.5,-0.6).curveTo(2.1,-1.2,2.1,-2.1).curveTo(2.1,-3.1,1.5,-3.7).curveTo(0.9,-4.2,0.1,-4.2).curveTo(-0.8,-4.2,-1.4,-3.7).closePath();
	this.shape_8.setTransform(-16.725,15.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.5,7).lineTo(-1.5,-2.5).lineTo(1.4,-2.5).lineTo(1.4,7).closePath().moveTo(-1.2,-4.1).curveTo(-1.7,-4.7,-1.7,-5.4).curveTo(-1.7,-6,-1.2,-6.5).curveTo(-0.7,-7,-0,-7).curveTo(0.7,-7,1.2,-6.5).curveTo(1.7,-6,1.7,-5.4).curveTo(1.7,-4.7,1.2,-4.1).curveTo(0.7,-3.7,-0,-3.7).curveTo(-0.7,-3.7,-1.2,-4.1).closePath();
	this.shape_9.setTransform(-24.875,10.95);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.4,6.7).lineTo(-4.4,-6.7).lineTo(4.4,-6.7).lineTo(4.4,-3.9).lineTo(-1.4,-3.9).lineTo(-1.4,-1).lineTo(3.7,-1).lineTo(3.7,1.7).lineTo(-1.3,1.7).lineTo(-1.3,6.7).closePath();
...
(lib.FHLeaderboard_728x90 = function(mode,startPosition,loop) {
	...
	this.btn1.setTransform(364.3,45.05,3.193,0.3093,0,0,0,0.1,0.1);
	...
	this.shape_78.setTransform(603.4317,53.3004,0.1808,0.1808);
	...
	this.shape_79.setTransform(621.2794,59.2201,0.1808,0.1808);
	...
	this.shape_152.graphics.beginFill("#323232").beginStroke().moveTo(-364,45).lineTo(-364,-45).lineTo(364,-45).lineTo(364,45).closePath();
