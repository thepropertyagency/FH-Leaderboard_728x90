...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#323232").beginStroke().moveTo(-1.4,6.9).lineTo(-1.4,-6.9).lineTo(1.5,-6.9).lineTo(1.5,6.9).closePath();
	this.shape.setTransform(57.85,11.075);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#323232").beginStroke().moveTo(-1.4,6.9).lineTo(-1.4,-6.9).lineTo(1.5,-6.9).lineTo(1.5,6.9).closePath();
	this.shape_1.setTransform(52.45,11.075);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#323232").beginStroke().moveTo(-1.5,7).lineTo(-1.5,-2.5).lineTo(1.4,-2.5).lineTo(1.4,7).closePath().moveTo(-1.2,-4.1).curveTo(-1.7,-4.7,-1.7,-5.4).curveTo(-1.7,-6,-1.2,-6.5).curveTo(-0.7,-7,-0,-7).curveTo(0.7,-7,1.2,-6.5).curveTo(1.7,-6,1.7,-5.4).curveTo(1.7,-4.7,1.2,-4.1).curveTo(0.7,-3.7,-0,-3.7).curveTo(-0.7,-3.7,-1.2,-4.1).closePath();
	this.shape_2.setTransform(47.075,10.95);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#323232").beginStroke().moveTo(2.7,6.7).lineTo(2.7,1.4).lineTo(-2.7,1.4).lineTo(-2.7,6.7).lineTo(-5.7,6.7).lineTo(-5.7,-6.7).lineTo(-2.7,-6.7).lineTo(-2.7,-1.5).lineTo(2.7,-1.5).lineTo(2.7,-6.7).lineTo(5.7,-6.7).lineTo(5.7,6.7).closePath();
	this.shape_3.setTransform(37.2,11.225);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#323232").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_4.setTransform(20.125,13.225);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#323232").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_5.setTransform(9.525,13.225);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#323232").beginStroke().moveTo(-3,4.8).lineTo(-3,-4.7).lineTo(-0.2,-4.7).lineTo(-0.2,-3.4).curveTo(0.5,-4.8,2.3,-4.8).lineTo(3,-4.7).lineTo(3,-1.8).lineTo(2.1,-1.9).curveTo(1.2,-1.9,0.6,-1.3).curveTo(-0.1,-0.7,-0.1,0.7).lineTo(-0.1,4.8).closePath();
	this.shape_6.setTransform(0.8,13.175);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#323232").beginStroke().moveTo(-0.6,5.4).curveTo(-1.5,4.6,-1.5,3.2).lineTo(-1.5,-0.9).lineTo(-3.2,-0.9).lineTo(-3.2,-3.4).lineTo(-2.7,-3.4).curveTo(-1.3,-3.4,-1.3,-5).lineTo(-1.3,-6.2).lineTo(1.4,-6.2).lineTo(1.4,-3.4).lineTo(3.2,-3.4).lineTo(3.2,-0.9).lineTo(1.4,-0.9).lineTo(1.4,2.6).curveTo(1.4,3.6,2.4,3.6).lineTo(3.2,3.5).lineTo(3.2,5.9).curveTo(2.6,6.2,1.6,6.2).curveTo(0.1,6.2,-0.6,5.4).closePath();
	this.shape_7.setTransform(-7.3,11.925);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#323232").beginStroke().moveTo(-3.4,5.7).curveTo(-4.6,4.7,-4.9,3.4).lineTo(-2.3,2.6).curveTo(-2.2,3.4,-1.6,3.8).curveTo(-1.1,4.2,-0.3,4.3).curveTo(2,4.3,2,1.8).lineTo(2,1.4).curveTo(1.3,2.4,-0.5,2.4).curveTo(-2.4,2.5,-3.6,1.2).curveTo(-4.9,-0.2,-4.9,-2.1).curveTo(-4.9,-4.1,-3.6,-5.4).curveTo(-2.4,-6.7,-0.5,-6.7).curveTo(1.5,-6.7,2.1,-5.6).lineTo(2.1,-6.6).lineTo(4.9,-6.6).lineTo(4.9,1.6).curveTo(4.9,3.9,3.7,5.2).curveTo(2.4,6.7,-0.2,6.8).curveTo(-2.1,6.8,-3.4,5.7).closePath().moveTo(-1.4,-3.7).curveTo(-2,-3.1,-2,-2.1).curveTo(-2,-1.2,-1.4,-0.6).curveTo(-0.8,-0,0.1,-0.1).curveTo(0.9,-0,1.5,-0.6).curveTo(2.1,-1.2,2.1,-2.1).curveTo(2.1,-3.1,1.5,-3.7).curveTo(0.9,-4.2,0.1,-4.2).curveTo(-0.8,-4.2,-1.4,-3.7).closePath();
	this.shape_8.setTransform(-16.725,15.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#323232").beginStroke().moveTo(-1.5,7).lineTo(-1.5,-2.5).lineTo(1.4,-2.5).lineTo(1.4,7).closePath().moveTo(-1.2,-4.1).curveTo(-1.7,-4.7,-1.7,-5.4).curveTo(-1.7,-6,-1.2,-6.5).curveTo(-0.7,-7,-0,-7).curveTo(0.7,-7,1.2,-6.5).curveTo(1.7,-6,1.7,-5.4).curveTo(1.7,-4.7,1.2,-4.1).curveTo(0.7,-3.7,-0,-3.7).curveTo(-0.7,-3.7,-1.2,-4.1).closePath();
	this.shape_9.setTransform(-24.875,10.95);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#323232").beginStroke().moveTo(-4.4,6.7).lineTo(-4.4,-6.7).lineTo(4.4,-6.7).lineTo(4.4,-3.9).lineTo(-1.4,-3.9).lineTo(-1.4,-1).lineTo(3.7,-1).lineTo(3.7,1.7).lineTo(-1.3,1.7).lineTo(-1.3,6.7).closePath();
	this.shape_10.setTransform(-32.55,11.225);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#323232").beginStroke().moveTo(-0.7,5.4).curveTo(-1.5,4.6,-1.5,3.2).lineTo(-1.5,-0.9).lineTo(-3.2,-0.9).lineTo(-3.2,-3.4).lineTo(-2.7,-3.4).curveTo(-1.2,-3.4,-1.2,-5).lineTo(-1.2,-6.2).lineTo(1.3,-6.2).lineTo(1.3,-3.4).lineTo(3.2,-3.4).lineTo(3.2,-0.9).lineTo(1.3,-0.9).lineTo(1.3,2.6).curveTo(1.3,3.6,2.4,3.6).lineTo(3.1,3.5).lineTo(3.1,5.9).curveTo(2.6,6.2,1.7,6.2).curveTo(0.2,6.2,-0.7,5.4).closePath();
	this.shape_11.setTransform(-46.85,11.925);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#323232").beginStroke().moveTo(-3.5,4.2).curveTo(-4.3,3.3,-4.3,2.2).curveTo(-4.3,0.9,-3.5,0.2).curveTo(-2.8,-0.5,-1.5,-0.7).lineTo(0.7,-1.1).curveTo(1.4,-1.2,1.4,-1.7).curveTo(1.4,-2.1,1,-2.4).curveTo(0.6,-2.7,-0,-2.7).curveTo(-0.7,-2.7,-1.2,-2.3).curveTo(-1.6,-1.9,-1.6,-1.3).lineTo(-4.1,-1.9).curveTo(-4,-3,-3.1,-3.9).curveTo(-1.9,-5,0,-5).curveTo(2.2,-5,3.3,-3.9).curveTo(4.2,-3,4.2,-1.3).lineTo(4.2,3.3).curveTo(4.2,4.2,4.3,4.7).lineTo(1.7,4.7).lineTo(1.6,3.7).curveTo(0.8,5,-1.1,5).curveTo(-2.5,5,-3.5,4.2).closePath().moveTo(-0.4,0.9).curveTo(-1.5,1.1,-1.5,1.9).curveTo(-1.5,2.9,-0.3,2.9).curveTo(1.4,2.9,1.4,1).lineTo(1.4,0.7).closePath();
	this.shape_12.setTransform(-55.575,13.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FF6400").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_13.setTransform(73.025,-8.825);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FF6400").beginStroke().moveTo(-1.3,4.7).lineTo(-5.2,-4.7).lineTo(-2.1,-4.7).lineTo(0.1,1.2).lineTo(2.1,-4.7).lineTo(5.2,-4.7).lineTo(1.6,4.7).closePath();
	this.shape_14.setTransform(62.325,-8.825);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FF6400").beginStroke().moveTo(-1.5,7).lineTo(-1.5,-2.5).lineTo(1.4,-2.5).lineTo(1.4,7).closePath().moveTo(-1.2,-4.1).curveTo(-1.7,-4.7,-1.7,-5.4).curveTo(-1.7,-6,-1.2,-6.5).curveTo(-0.7,-7,-0,-7).curveTo(0.7,-7,1.2,-6.5).curveTo(1.7,-6,1.7,-5.4).curveTo(1.7,-4.7,1.2,-4.1).curveTo(0.7,-3.7,-0,-3.7).curveTo(-0.7,-3.7,-1.2,-4.1).closePath();
	this.shape_15.setTransform(54.275,-11.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FF6400").beginStroke().moveTo(-1.4,6.9).lineTo(-1.4,-6.9).lineTo(1.5,-6.9).lineTo(1.5,6.9).closePath();
	this.shape_16.setTransform(48.85,-10.975);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FF6400").beginStroke().moveTo(-3.6,3.6).curveTo(-5,2.2,-5,-0).curveTo(-5,-2.2,-3.6,-3.6).curveTo(-2.2,-5,0,-5).curveTo(2.1,-5,3.6,-3.6).curveTo(5,-2.2,5,-0).curveTo(5,2.2,3.6,3.6).curveTo(2.1,5,0,5).curveTo(-2.1,5,-3.6,3.6).closePath().moveTo(-1.4,-1.8).curveTo(-2.1,-1.1,-2.1,-0).curveTo(-2.1,1.1,-1.4,1.8).curveTo(-0.9,2.4,0,2.4).curveTo(0.9,2.4,1.5,1.8).curveTo(2.1,1.1,2.2,-0).curveTo(2.1,-1.1,1.5,-1.8).curveTo(0.9,-2.3,0,-2.3).curveTo(-0.9,-2.3,-1.4,-1.8).closePath();
	this.shape_17.setTransform(35.9,-8.825);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#FF6400").beginStroke().moveTo(-0.6,5.4).curveTo(-1.5,4.6,-1.5,3.2).lineTo(-1.5,-0.9).lineTo(-3.2,-0.9).lineTo(-3.2,-3.4).lineTo(-2.7,-3.4).curveTo(-1.3,-3.4,-1.3,-5).lineTo(-1.3,-6.2).lineTo(1.4,-6.2).lineTo(1.4,-3.4).lineTo(3.2,-3.4).lineTo(3.2,-0.9).lineTo(1.4,-0.9).lineTo(1.4,2.6).curveTo(1.4,3.6,2.4,3.6).lineTo(3.2,3.5).lineTo(3.2,5.9).curveTo(2.6,6.2,1.6,6.2).curveTo(0.1,6.2,-0.6,5.4).closePath();
	this.shape_18.setTransform(26.45,-10.125);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.beginFill("#FF6400").beginStroke().moveTo(-0.7,5.4).curveTo(-1.5,4.6,-1.5,3.2).lineTo(-1.5,-0.9).lineTo(-3.2,-0.9).lineTo(-3.2,-3.4).lineTo(-2.7,-3.4).curveTo(-1.2,-3.4,-1.2,-5).lineTo(-1.2,-6.2).lineTo(1.4,-6.2).lineTo(1.4,-3.4).lineTo(3.2,-3.4).lineTo(3.2,-0.9).lineTo(1.4,-0.9).lineTo(1.4,2.6).curveTo(1.4,3.6,2.4,3.6).lineTo(3.2,3.5).lineTo(3.2,5.9).curveTo(2.6,6.2,1.6,6.2).curveTo(0.2,6.2,-0.7,5.4).closePath();
	this.shape_19.setTransform(14.55,-10.125);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.beginFill("#FF6400").beginStroke().moveTo(-3,3.9).curveTo(-3.8,3.1,-3.9,2).lineTo(-1.4,1.6).curveTo(-1.4,2.1,-1,2.5).curveTo(-0.6,2.9,0.1,2.9).curveTo(1.2,2.9,1.2,2.1).curveTo(1.2,1.5,0.2,1.3).lineTo(-0.9,1).curveTo(-3.7,0.4,-3.7,-1.9).curveTo(-3.7,-3.2,-2.6,-4.1).curveTo(-1.6,-5,-0,-5).curveTo(1.8,-5,2.8,-4).curveTo(3.6,-3.2,3.7,-2.2).lineTo(1.3,-1.8).curveTo(1.2,-2.9,-0,-2.9).curveTo(-0.4,-2.9,-0.7,-2.7).curveTo(-1,-2.5,-1,-2.1).curveTo(-1,-1.5,-0.3,-1.4).lineTo(1,-1.1).curveTo(2.4,-0.9,3.1,-0).curveTo(3.9,0.7,3.9,1.8).curveTo(3.9,3.1,2.9,4).curveTo(1.9,5,0.1,5).curveTo(-1.9,5,-3,3.9).closePath();
	this.shape_20.setTransform(6.675,-8.825);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.beginFill("#FF6400").beginStroke().moveTo(-3,4.8).lineTo(-3,-4.7).lineTo(-0.2,-4.7).lineTo(-0.2,-3.4).curveTo(0.4,-4.8,2.3,-4.8).lineTo(3,-4.7).lineTo(3,-1.8).lineTo(2.1,-1.9).curveTo(1.1,-1.9,0.6,-1.3).curveTo(-0.1,-0.7,-0.1,0.7).lineTo(-0.1,4.8).closePath();
	this.shape_21.setTransform(-1.1,-8.875);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.beginFill("#FF6400").beginStroke().moveTo(-1.5,7).lineTo(-1.5,-2.5).lineTo(1.4,-2.5).lineTo(1.4,7).closePath().moveTo(-1.2,-4.1).curveTo(-1.7,-4.7,-1.7,-5.4).curveTo(-1.7,-6,-1.2,-6.5).curveTo(-0.7,-7,-0,-7).curveTo(0.7,-7,1.2,-6.5).curveTo(1.7,-6,1.7,-5.4).curveTo(1.7,-4.7,1.2,-4.1).curveTo(0.7,-3.7,-0,-3.7).curveTo(-0.7,-3.7,-1.2,-4.1).closePath();
	this.shape_22.setTransform(-8.025,-11.1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.beginFill("#FF6400").beginStroke().moveTo(-1.8,6.9).lineTo(-1.8,-0).lineTo(-3.2,-0).lineTo(-3.2,-2.5).lineTo(-1.8,-2.5).lineTo(-1.8,-3.3).curveTo(-1.8,-5,-0.8,-6).curveTo(0.2,-7,1.8,-7).curveTo(2.8,-7,3.3,-6.8).lineTo(3.3,-4.4).lineTo(2.4,-4.5).curveTo(1.2,-4.5,1.2,-3.2).lineTo(1.2,-2.5).lineTo(3.2,-2.5).lineTo(3.2,-0).lineTo(1.2,-0).lineTo(1.2,6.9).closePath();
	this.shape_23.setTransform(-14.15,-11.05);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.beginFill("#FF6400").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_24.setTransform(-27.525,-8.825);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.beginFill("#FF6400").beginStroke().moveTo(1.5,6.9).lineTo(1.5,1.4).curveTo(1.5,-0.2,0,-0.2).curveTo(-0.7,-0.2,-1.1,0.2).curveTo(-1.5,0.7,-1.5,1.3).lineTo(-1.5,6.9).lineTo(-4.5,6.9).lineTo(-4.5,-6.9).lineTo(-1.5,-6.9).lineTo(-1.5,-2).curveTo(-0.7,-2.8,0.9,-2.8).curveTo(2.6,-2.8,3.6,-1.7).curveTo(4.4,-0.7,4.4,0.9).lineTo(4.4,6.9).closePath();
	this.shape_25.setTransform(-38.45,-10.975);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.beginFill("#FF6400").beginStroke().moveTo(-0.7,5.4).curveTo(-1.5,4.6,-1.5,3.2).lineTo(-1.5,-0.9).lineTo(-3.2,-0.9).lineTo(-3.2,-3.4).lineTo(-2.7,-3.4).curveTo(-1.2,-3.4,-1.2,-5).lineTo(-1.2,-6.2).lineTo(1.4,-6.2).lineTo(1.4,-3.4).lineTo(3.2,-3.4).lineTo(3.2,-0.9).lineTo(1.4,-0.9).lineTo(1.4,2.6).curveTo(1.4,3.6,2.4,3.6).lineTo(3.2,3.5).lineTo(3.2,5.9).curveTo(2.6,6.2,1.6,6.2).curveTo(0.2,6.2,-0.7,5.4).closePath();
	this.shape_26.setTransform(-48,-10.125);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.beginFill("#FF6400").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_27.setTransform(-61.325,-8.825);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.beginFill("#FF6400").beginStroke().moveTo(-4.8,6.7).lineTo(-4.8,-6.7).lineTo(0.2,-6.7).curveTo(2.2,-6.7,3.3,-5.7).curveTo(4.4,-4.7,4.4,-3.1).curveTo(4.4,-2.1,3.8,-1.3).curveTo(3.3,-0.5,2.4,-0.3).curveTo(3.4,-0,4.1,0.8).curveTo(4.8,1.7,4.8,2.9).curveTo(4.8,4.6,3.7,5.6).curveTo(2.5,6.7,0.6,6.7).closePath().moveTo(-1.9,4.3).lineTo(-0,4.3).curveTo(0.9,4.3,1.4,3.8).curveTo(1.9,3.4,1.9,2.7).curveTo(1.9,2,1.4,1.6).curveTo(0.9,1.1,-0,1.1).lineTo(-1.9,1.1).closePath().moveTo(-1.9,-1.3).lineTo(-0.3,-1.3).curveTo(0.5,-1.3,1,-1.7).curveTo(1.5,-2.1,1.5,-2.8).curveTo(1.5,-4.3,-0.3,-4.3).lineTo(-1.9,-4.3).closePath();
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#323232").beginStroke().moveTo(-2.7,4.3).lineTo(-2.7,-4.2).lineTo(-0.2,-4.2).lineTo(-0.2,-3).curveTo(0.4,-4.3,2,-4.3).lineTo(2.7,-4.2).lineTo(2.7,-1.6).lineTo(1.9,-1.7).curveTo(1,-1.7,0.5,-1.2).curveTo(-0.1,-0.6,-0.1,0.6).lineTo(-0.1,4.3).closePath();
	this.shape.setTransform(40.725,18.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#323232").beginStroke().moveTo(-3.2,3.3).curveTo(-4,2.4,-4,1).lineTo(-4,-4.3).lineTo(-1.4,-4.3).lineTo(-1.4,0.5).curveTo(-1.4,1.1,-1.1,1.5).curveTo(-0.7,1.9,-0.1,1.9).curveTo(0.6,1.9,1,1.5).curveTo(1.3,1.1,1.3,0.5).lineTo(1.3,-4.3).lineTo(3.9,-4.3).lineTo(3.9,2.6).lineTo(4,4.1).lineTo(1.5,4.1).lineTo(1.4,3.3).curveTo(0.8,4.3,-0.8,4.3).curveTo(-2.3,4.3,-3.2,3.3).closePath();
	this.shape_1.setTransform(31.875,18.575);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#323232").beginStroke().moveTo(1.4,6.1).lineTo(1.4,1.3).curveTo(1.4,-0.2,-0,-0.2).curveTo(-0.6,-0.2,-1,0.2).curveTo(-1.4,0.6,-1.4,1.2).lineTo(-1.4,6.1).lineTo(-4,6.1).lineTo(-4,-6.1).lineTo(-1.4,-6.1).lineTo(-1.4,-1.8).curveTo(-0.6,-2.5,0.8,-2.5).curveTo(2.3,-2.5,3.2,-1.5).curveTo(4,-0.7,4,0.8).lineTo(4,6.1).closePath();
	this.shape_2.setTransform(21.825,16.55);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#323232").beginStroke().moveTo(-0.6,4.8).curveTo(-1.3,4.1,-1.3,2.8).lineTo(-1.3,-0.8).lineTo(-2.9,-0.8).lineTo(-2.9,-3.1).lineTo(-2.4,-3.1).curveTo(-1.1,-3.1,-1.2,-4.5).lineTo(-1.2,-5.5).lineTo(1.2,-5.5).lineTo(1.2,-3.1).lineTo(2.8,-3.1).lineTo(2.8,-0.8).lineTo(1.2,-0.8).lineTo(1.2,2.3).curveTo(1.2,3.2,2.1,3.2).lineTo(2.8,3.2).lineTo(2.8,5.3).curveTo(2.3,5.5,1.5,5.5).curveTo(0.2,5.5,-0.6,4.8).closePath();
	this.shape_3.setTransform(13.3,17.325);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#323232").beginStroke().moveTo(-2.7,4.3).lineTo(-2.7,-4.2).lineTo(-0.2,-4.2).lineTo(-0.2,-3).curveTo(0.4,-4.3,2,-4.3).lineTo(2.7,-4.2).lineTo(2.7,-1.6).lineTo(1.9,-1.7).curveTo(1,-1.7,0.5,-1.2).curveTo(-0.1,-0.6,-0.1,0.6).lineTo(-0.1,4.3).closePath();
	this.shape_4.setTransform(7.225,18.425);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#323232").beginStroke().moveTo(-3.1,3.7).curveTo(-3.9,3,-3.9,1.9).curveTo(-3.9,0.8,-3.2,0.1).curveTo(-2.4,-0.5,-1.4,-0.7).lineTo(0.6,-1).curveTo(1.2,-1.1,1.3,-1.5).curveTo(1.2,-1.9,0.9,-2.2).curveTo(0.5,-2.5,-0,-2.5).curveTo(-0.6,-2.5,-1.1,-2.1).curveTo(-1.4,-1.7,-1.4,-1.2).lineTo(-3.7,-1.7).curveTo(-3.6,-2.7,-2.8,-3.5).curveTo(-1.7,-4.5,-0,-4.5).curveTo(2,-4.5,2.9,-3.5).curveTo(3.8,-2.6,3.8,-1.2).lineTo(3.8,2.9).lineTo(3.9,4.2).lineTo(1.5,4.2).lineTo(1.4,3.3).curveTo(0.7,4.5,-1,4.5).curveTo(-2.3,4.5,-3.1,3.7).closePath().moveTo(-0.4,0.8).curveTo(-1.3,0.9,-1.3,1.7).curveTo(-1.3,2.6,-0.3,2.6).curveTo(1.3,2.6,1.3,0.9).lineTo(1.3,0.5).closePath();
	this.shape_5.setTransform(-1.35,18.475);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#323232").beginStroke().moveTo(-3,3.2).curveTo(-4.3,2,-4.3,0).curveTo(-4.3,-1.9,-3,-3.2).curveTo(-1.7,-4.5,0.2,-4.5).curveTo(1.8,-4.5,3,-3.6).curveTo(3.9,-2.8,4.2,-1.5).lineTo(1.9,-0.8).curveTo(1.6,-2.1,0.3,-2.1).curveTo(-0.6,-2.1,-1.2,-1.6).curveTo(-1.7,-1,-1.7,0).curveTo(-1.7,1,-1.1,1.6).curveTo(-0.6,2.1,0.3,2.1).curveTo(1.7,2.1,2,0.8).lineTo(4.3,1.5).curveTo(4,2.8,3,3.6).curveTo(1.8,4.5,0.3,4.5).curveTo(-1.7,4.5,-3,3.2).closePath();
	this.shape_6.setTransform(-10.55,18.475);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#323232").beginStroke().moveTo(-3.1,3.7).curveTo(-3.8,3,-3.8,1.9).curveTo(-3.9,0.8,-3.1,0.1).curveTo(-2.5,-0.5,-1.3,-0.7).lineTo(0.6,-1).curveTo(1.3,-1.1,1.3,-1.5).curveTo(1.3,-1.9,0.9,-2.2).curveTo(0.5,-2.5,0,-2.5).curveTo(-0.7,-2.5,-1.1,-2.1).curveTo(-1.4,-1.7,-1.4,-1.2).lineTo(-3.7,-1.7).curveTo(-3.6,-2.7,-2.8,-3.5).curveTo(-1.7,-4.5,0,-4.5).curveTo(1.9,-4.5,2.9,-3.5).curveTo(3.8,-2.6,3.7,-1.2).lineTo(3.7,2.9).lineTo(3.8,4.2).lineTo(1.5,4.2).lineTo(1.5,3.3).curveTo(0.7,4.5,-1,4.5).curveTo(-2.3,4.5,-3.1,3.7).closePath().moveTo(-0.3,0.8).curveTo(-1.3,0.9,-1.3,1.7).curveTo(-1.3,2.6,-0.3,2.6).curveTo(1.2,2.6,1.3,0.9).lineTo(1.3,0.5).closePath();
	this.shape_7.setTransform(-20.1,18.475);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#323232").beginStroke().moveTo(4.2,6).lineTo(4.2,-2).lineTo(1.1,6).lineTo(-1.1,6).lineTo(-4.3,-1.9).lineTo(-4.3,6).lineTo(-6.8,6).lineTo(-6.8,-6).lineTo(-3.3,-6).lineTo(0,2.1).lineTo(3.1,-6).lineTo(6.8,-6).lineTo(6.8,6).closePath();
	this.shape_8.setTransform(-32.725,16.675);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#323232").beginStroke().moveTo(-2.9,3.3).curveTo(-4.2,2,-4.2,-0).curveTo(-4.2,-2,-2.9,-3.3).curveTo(-1.7,-4.5,0,-4.5).curveTo(2,-4.5,3.1,-3.3).curveTo(4.2,-2.2,4.2,-0.1).lineTo(4.2,0.7).lineTo(-1.7,0.7).curveTo(-1.6,1.4,-1.1,1.8).curveTo(-0.5,2.3,0.2,2.3).curveTo(1.5,2.3,1.9,1.2).lineTo(4.1,1.8).curveTo(3.8,3,2.8,3.7).curveTo(1.7,4.5,0.2,4.5).curveTo(-1.6,4.5,-2.9,3.3).closePath().moveTo(1.7,-1).curveTo(1.7,-1.6,1.4,-2).curveTo(0.9,-2.4,0,-2.4).curveTo(-0.7,-2.4,-1.2,-2).curveTo(-1.6,-1.6,-1.6,-1).lineTo(1.7,-1).lineTo(1.7,-1).closePath();
	this.shape_9.setTransform(66.975,-0.025);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#323232").beginStroke().moveTo(1.4,6.2).lineTo(1.4,1.3).curveTo(1.4,-0.2,-0,-0.2).curveTo(-0.6,-0.2,-1,0.2).curveTo(-1.4,0.6,-1.4,1.2).lineTo(-1.4,6.2).lineTo(-4,6.2).lineTo(-4,-6.2).lineTo(-1.4,-6.2).lineTo(-1.4,-1.7).curveTo(-0.6,-2.5,0.8,-2.5).curveTo(2.3,-2.5,3.2,-1.6).curveTo(4,-0.6,4,0.9).lineTo(4,6.2).closePath();
	this.shape_10.setTransform(57.275,-1.95);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#323232").beginStroke().moveTo(-0.6,4.8).curveTo(-1.4,4.1,-1.3,2.8).lineTo(-1.3,-0.8).lineTo(-2.9,-0.8).lineTo(-2.9,-3.1).lineTo(-2.5,-3.1).curveTo(-1.2,-3.1,-1.1,-4.5).lineTo(-1.1,-5.5).lineTo(1.2,-5.5).lineTo(1.2,-3.1).lineTo(2.8,-3.1).lineTo(2.8,-0.8).lineTo(1.2,-0.8).lineTo(1.2,2.3).curveTo(1.2,3.2,2.1,3.2).lineTo(2.8,3.2).lineTo(2.8,5.3).curveTo(2.3,5.5,1.5,5.5).curveTo(0.2,5.5,-0.6,4.8).closePath();
	this.shape_11.setTransform(48.75,-1.175);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#323232").beginStroke().moveTo(1.4,4.3).lineTo(1.4,-0.5).curveTo(1.4,-2,-0,-2).curveTo(-0.6,-2,-1,-1.6).curveTo(-1.4,-1.2,-1.4,-0.5).lineTo(-1.4,4.3).lineTo(-4,4.3).lineTo(-4,-4.1).lineTo(-1.5,-4.1).lineTo(-1.5,-3.2).curveTo(-1.2,-3.7,-0.5,-4.1).curveTo(0.2,-4.3,0.9,-4.3).curveTo(2.4,-4.3,3.2,-3.4).curveTo(4,-2.5,4,-1).lineTo(4,4.3).closePath();
	this.shape_12.setTransform(36.575,-0.125);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#323232").beginStroke().moveTo(-1.3,6.3).lineTo(-1.3,-2.2).lineTo(1.3,-2.2).lineTo(1.3,6.3).closePath().moveTo(-1.1,-3.7).curveTo(-1.5,-4.1,-1.5,-4.8).curveTo(-1.5,-5.4,-1.1,-5.8).curveTo(-0.6,-6.3,-0,-6.3).curveTo(0.6,-6.3,1.1,-5.8).curveTo(1.5,-5.4,1.5,-4.8).curveTo(1.5,-4.1,1.1,-3.7).curveTo(0.6,-3.2,-0,-3.2).curveTo(-0.6,-3.2,-1.1,-3.7).closePath();
	this.shape_13.setTransform(29.075,-2.075);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#323232").beginStroke().moveTo(-3.1,5.9).lineTo(-1.2,1.5).lineTo(-4.8,-5.8).lineTo(-1.9,-5.8).lineTo(0.2,-1.3).lineTo(2,-5.8).lineTo(4.8,-5.8).lineTo(-0.4,5.9).closePath();
	this.shape_14.setTransform(17.575,1.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#323232").beginStroke().moveTo(-0.6,4.8).curveTo(-1.4,4.1,-1.4,2.8).lineTo(-1.4,-0.8).lineTo(-2.8,-0.8).lineTo(-2.8,-3.1).lineTo(-2.5,-3.1).curveTo(-1.1,-3.1,-1.1,-4.5).lineTo(-1.1,-5.5).lineTo(1.2,-5.5).lineTo(1.2,-3.1).lineTo(2.8,-3.1).lineTo(2.8,-0.8).lineTo(1.2,-0.8).lineTo(1.2,2.3).curveTo(1.2,3.2,2.1,3.2).lineTo(2.8,3.2).lineTo(2.8,5.3).curveTo(2.3,5.5,1.4,5.5).curveTo(0.1,5.5,-0.6,4.8).closePath();
	this.shape_15.setTransform(9.3,-1.175);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#323232").beginStroke().moveTo(-1.3,6.3).lineTo(-1.3,-2.2).lineTo(1.3,-2.2).lineTo(1.3,6.3).closePath().moveTo(-1.1,-3.7).curveTo(-1.5,-4.1,-1.5,-4.8).curveTo(-1.5,-5.4,-1.1,-5.8).curveTo(-0.6,-6.3,-0,-6.3).curveTo(0.6,-6.3,1.1,-5.8).curveTo(1.5,-5.4,1.5,-4.8).curveTo(1.5,-4.1,1.1,-3.7).curveTo(0.6,-3.2,-0,-3.2).curveTo(-0.6,-3.2,-1.1,-3.7).closePath();
	this.shape_16.setTransform(3.875,-2.075);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#323232").beginStroke().moveTo(1.4,4.3).lineTo(1.4,-0.5).curveTo(1.4,-2,-0,-2).curveTo(-0.6,-2,-1,-1.6).curveTo(-1.4,-1.2,-1.4,-0.5).lineTo(-1.4,4.3).lineTo(-4,4.3).lineTo(-4,-4.1).lineTo(-1.5,-4.1).lineTo(-1.5,-3.2).curveTo(-1.2,-3.7,-0.5,-4.1).curveTo(0.2,-4.3,0.9,-4.3).curveTo(2.4,-4.3,3.2,-3.4).curveTo(4,-2.5,4,-1).lineTo(4,4.3).closePath();
	this.shape_17.setTransform(-3.525,-0.125);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#323232").beginStroke().moveTo(-3.2,3.3).curveTo(-4,2.4,-4,1).lineTo(-4,-4.3).lineTo(-1.4,-4.3).lineTo(-1.4,0.5).curveTo(-1.4,1.1,-1.1,1.5).curveTo(-0.7,1.9,-0.1,1.9).curveTo(0.6,1.9,1,1.5).curveTo(1.3,1.1,1.3,0.5).lineTo(1.3,-4.3).lineTo(3.9,-4.3).lineTo(3.9,2.6).lineTo(4,4.1).lineTo(1.5,4.1).lineTo(1.4,3.3).curveTo(0.8,4.3,-0.8,4.3).curveTo(-2.3,4.3,-3.2,3.3).closePath();
	this.shape_18.setTransform(-13.675,0.075);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.beginFill("#323232").beginStroke().moveTo(4.1,4.4).lineTo(4.1,-0.6).curveTo(4.1,-2,2.7,-2).curveTo(2.1,-2,1.7,-1.6).curveTo(1.3,-1.2,1.3,-0.6).lineTo(1.3,4.4).lineTo(-1.3,4.4).lineTo(-1.3,-0.6).curveTo(-1.3,-2,-2.6,-2).curveTo(-3.3,-2,-3.6,-1.6).curveTo(-4,-1.1,-4,-0.5).lineTo(-4,4.4).lineTo(-6.6,4.4).lineTo(-6.6,-4.1).lineTo(-4.1,-4.1).lineTo(-4.1,-3.2).curveTo(-3.8,-3.7,-3.1,-4.1).curveTo(-2.4,-4.4,-1.7,-4.4).curveTo(0.1,-4.4,0.8,-3.1).curveTo(1.7,-4.4,3.4,-4.4).curveTo(4.7,-4.3,5.6,-3.6).curveTo(6.6,-2.7,6.6,-1.1).lineTo(6.6,4.4).closePath();
	this.shape_19.setTransform(-26.325,-0.15);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.beginFill("#323232").beginStroke().moveTo(4.1,4.4).lineTo(4.1,-0.6).curveTo(4.1,-2,2.7,-2).curveTo(2.1,-2,1.7,-1.6).curveTo(1.3,-1.2,1.3,-0.6).lineTo(1.3,4.4).lineTo(-1.3,4.4).lineTo(-1.3,-0.6).curveTo(-1.3,-2,-2.6,-2).curveTo(-3.3,-2,-3.6,-1.6).curveTo(-4,-1.1,-4,-0.5).lineTo(-4,4.4).lineTo(-6.6,4.4).lineTo(-6.6,-4.1).lineTo(-4.1,-4.1).lineTo(-4.1,-3.2).curveTo(-3.8,-3.7,-3.1,-4.1).curveTo(-2.4,-4.4,-1.7,-4.4).curveTo(0.1,-4.4,0.8,-3.1).curveTo(1.7,-4.4,3.4,-4.4).curveTo(4.7,-4.3,5.6,-3.6).curveTo(6.6,-2.7,6.6,-1.1).lineTo(6.6,4.4).closePath();
	this.shape_20.setTransform(-41.625,-0.15);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.beginFill("#323232").beginStroke().moveTo(-3.2,3.2).curveTo(-4.5,1.9,-4.5,-0).curveTo(-4.5,-2,-3.2,-3.2).curveTo(-1.9,-4.5,-0,-4.5).curveTo(2,-4.5,3.2,-3.2).curveTo(4.5,-2,4.5,-0).curveTo(4.5,1.9,3.2,3.2).curveTo(2,4.5,-0,4.5).curveTo(-1.9,4.5,-3.2,3.2).closePath().moveTo(-1.3,-1.6).curveTo(-1.9,-1,-1.9,-0).curveTo(-1.9,1,-1.3,1.6).curveTo(-0.7,2.1,-0,2.1).curveTo(0.8,2.1,1.3,1.6).curveTo(1.9,1,1.9,-0).curveTo(1.9,-1,1.3,-1.6).curveTo(0.8,-2.1,-0,-2.1).curveTo(-0.7,-2.1,-1.3,-1.6).closePath();
	this.shape_21.setTransform(-54.35,-0.025);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.beginFill("#323232").beginStroke().moveTo(-2.9,3.2).curveTo(-4.3,2,-4.3,0).curveTo(-4.3,-1.9,-2.9,-3.2).curveTo(-1.7,-4.5,0.2,-4.5).curveTo(1.8,-4.5,2.9,-3.6).curveTo(3.9,-2.8,4.3,-1.5).lineTo(1.9,-0.8).curveTo(1.6,-2.1,0.2,-2.1).curveTo(-0.6,-2.1,-1.1,-1.6).curveTo(-1.7,-1,-1.7,0).curveTo(-1.7,1,-1.1,1.6).curveTo(-0.5,2.1,0.2,2.1).curveTo(1.6,2.1,2,0.8).lineTo(4.3,1.5).curveTo(4,2.8,3,3.6).curveTo(1.8,4.5,0.2,4.5).curveTo(-1.6,4.5,-2.9,3.2).closePath();
	this.shape_22.setTransform(-64.05,-0.025);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.beginFill("#323232").beginStroke().moveTo(-4.5,5.9).lineTo(-4.5,-5.8).lineTo(-1.9,-5.8).lineTo(-1.9,-4.9).curveTo(-1.7,-5.4,-1,-5.6).curveTo(-0.4,-5.9,0.5,-6).curveTo(2.3,-6,3.4,-4.7).curveTo(4.4,-3.5,4.4,-1.5).curveTo(4.4,0.4,3.3,1.6).curveTo(2.2,2.9,0.4,2.9).curveTo(-1.2,2.9,-1.8,2.1).lineTo(-1.8,5.9).closePath().moveTo(-1.3,-3.1).curveTo(-1.9,-2.6,-1.9,-1.5).curveTo(-1.9,-0.6,-1.3,0.1).curveTo(-0.8,0.6,0,0.6).curveTo(0.8,0.6,1.4,0.1).curveTo(1.9,-0.5,1.9,-1.5).curveTo(1.9,-2.6,1.4,-3.1).curveTo(0.8,-3.7,0,-3.6).curveTo(-0.8,-3.7,-1.3,-3.1).closePath();
	...
	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.beginFill("#323232").beginStroke().moveTo(1.4,6.1).lineTo(1.4,1.3).curveTo(1.4,-0.2,-0,-0.2).curveTo(-0.6,-0.2,-1,0.2).curveTo(-1.4,0.6,-1.4,1.2).lineTo(-1.4,6.1).lineTo(-4,6.1).lineTo(-4,-6.2).lineTo(-1.4,-6.2).lineTo(-1.4,-1.8).curveTo(-0.6,-2.5,0.8,-2.5).curveTo(2.3,-2.5,3.2,-1.5).curveTo(4,-0.7,4,0.8).lineTo(4,6.1).closePath();
	this.shape_25.setTransform(40.475,-20.45);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.beginFill("#323232").beginStroke().moveTo(-2.7,3.5).curveTo(-3.4,2.8,-3.5,1.8).lineTo(-1.3,1.4).curveTo(-1.3,1.9,-0.9,2.2).curveTo(-0.6,2.6,0,2.6).curveTo(1,2.6,1,1.8).curveTo(1,1.3,0.2,1.1).lineTo(-0.8,0.9).curveTo(-3.3,0.4,-3.3,-1.7).curveTo(-3.3,-2.8,-2.4,-3.7).curveTo(-1.5,-4.5,-0,-4.5).curveTo(1.6,-4.5,2.5,-3.6).curveTo(3.3,-2.9,3.3,-2).lineTo(1.2,-1.6).curveTo(1.1,-2.6,-0,-2.6).curveTo(-0.4,-2.6,-0.7,-2.4).curveTo(-0.9,-2.2,-0.9,-1.9).curveTo(-0.9,-1.4,-0.3,-1.2).lineTo(0.8,-1).curveTo(2.1,-0.8,2.8,-0).curveTo(3.5,0.7,3.5,1.6).curveTo(3.5,2.8,2.6,3.6).curveTo(1.7,4.5,0.1,4.5).curveTo(-1.7,4.5,-2.7,3.5).closePath();
	this.shape_26.setTransform(31.375,-18.525);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.beginFill("#323232").beginStroke().moveTo(-3.1,5.1).curveTo(-4.2,4.3,-4.4,3).lineTo(-2.1,2.4).curveTo(-2,3,-1.5,3.4).curveTo(-1,3.8,-0.3,3.8).curveTo(1.8,3.8,1.8,1.6).lineTo(1.8,1.3).curveTo(1.2,2.2,-0.5,2.2).curveTo(-2.1,2.2,-3.3,1).curveTo(-4.4,-0.2,-4.4,-1.9).curveTo(-4.4,-3.7,-3.3,-4.8).curveTo(-2.2,-6,-0.5,-6).curveTo(1.3,-6.1,1.9,-5).lineTo(1.9,-5.9).lineTo(4.4,-5.9).lineTo(4.4,1.5).curveTo(4.4,3.5,3.3,4.7).curveTo(2.1,6,-0.2,6).curveTo(-1.9,6,-3.1,5.1).closePath().moveTo(-1.2,-3.3).curveTo(-1.8,-2.7,-1.8,-1.9).curveTo(-1.8,-1.1,-1.3,-0.5).curveTo(-0.8,-0.1,0,-0.1).curveTo(0.8,-0.1,1.3,-0.5).curveTo(1.8,-1.1,1.8,-1.9).curveTo(1.8,-2.7,1.3,-3.3).curveTo(0.8,-3.8,0,-3.8).curveTo(-0.7,-3.8,-1.2,-3.3).closePath();
	this.shape_27.setTransform(22.075,-16.85);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.beginFill("#323232").beginStroke().moveTo(-3.1,3.7).curveTo(-3.8,3,-3.8,1.9).curveTo(-3.9,0.8,-3.1,0.1).curveTo(-2.5,-0.5,-1.3,-0.7).lineTo(0.6,-1).curveTo(1.3,-1.1,1.3,-1.5).curveTo(1.3,-1.9,0.9,-2.2).curveTo(0.6,-2.5,0,-2.5).curveTo(-0.7,-2.5,-1.1,-2.1).curveTo(-1.4,-1.7,-1.4,-1.2).lineTo(-3.7,-1.7).curveTo(-3.6,-2.7,-2.8,-3.5).curveTo(-1.7,-4.5,0,-4.5).curveTo(1.9,-4.5,2.9,-3.5).curveTo(3.8,-2.6,3.7,-1.2).lineTo(3.7,2.9).lineTo(3.9,4.2).lineTo(1.5,4.2).lineTo(1.5,3.3).curveTo(0.7,4.5,-1,4.5).curveTo(-2.3,4.5,-3.1,3.7).closePath().moveTo(-0.3,0.8).curveTo(-1.3,0.9,-1.3,1.7).curveTo(-1.3,2.6,-0.3,2.6).curveTo(1.3,2.6,1.3,0.9).lineTo(1.3,0.5).closePath();
	this.shape_28.setTransform(12.4,-18.525);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.beginFill("#323232").beginStroke().moveTo(-1.3,6.1).lineTo(-1.3,-6.2).lineTo(1.3,-6.2).lineTo(1.3,6.1).closePath();
	this.shape_29.setTransform(5.5,-20.45);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.beginFill("#323232").beginStroke().moveTo(-1.5,6.2).lineTo(-1.5,-0.1).lineTo(-2.9,-0.1).lineTo(-2.9,-2.2).lineTo(-1.5,-2.2).lineTo(-1.5,-3).curveTo(-1.6,-4.4,-0.7,-5.3).curveTo(0.1,-6.2,1.6,-6.2).curveTo(2.5,-6.2,2.9,-6).lineTo(2.9,-3.9).lineTo(2.1,-4).curveTo(1,-4,1,-2.9).lineTo(1,-2.2).lineTo(2.9,-2.2).lineTo(2.9,-0.1).lineTo(1,-0.1).lineTo(1,6.2).closePath();
	this.shape_30.setTransform(0,-20.525);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.beginFill("#323232").beginStroke().moveTo(1.8,4.2).lineTo(-0,-1.2).lineTo(-1.8,4.2).lineTo(-4.4,4.2).lineTo(-7.1,-4.2).lineTo(-4.4,-4.2).lineTo(-2.9,0.8).lineTo(-1.3,-4.2).lineTo(1.5,-4.2).lineTo(3.1,0.8).lineTo(4.5,-4.2).lineTo(7.1,-4.2).lineTo(4.4,4.2).closePath();
	this.shape_31.setTransform(-14.45,-18.525);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.beginFill("#323232").beginStroke().moveTo(-2.9,3.3).curveTo(-4.2,2,-4.2,-0).curveTo(-4.2,-2,-2.9,-3.3).curveTo(-1.7,-4.5,0,-4.5).curveTo(2,-4.5,3.1,-3.3).curveTo(4.2,-2.2,4.2,-0.1).lineTo(4.2,0.7).lineTo(-1.7,0.7).curveTo(-1.6,1.4,-1.1,1.8).curveTo(-0.5,2.3,0.2,2.3).curveTo(1.5,2.3,1.9,1.2).lineTo(4.1,1.8).curveTo(3.8,3,2.8,3.7).curveTo(1.7,4.5,0.2,4.5).curveTo(-1.6,4.5,-2.9,3.3).closePath().moveTo(1.7,-1).curveTo(1.7,-1.6,1.4,-2).curveTo(0.9,-2.4,0,-2.4).curveTo(-0.7,-2.4,-1.2,-2).curveTo(-1.6,-1.6,-1.6,-1).lineTo(1.7,-1).lineTo(1.7,-1).closePath();
	this.shape_32.setTransform(-26.475,-18.525);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.beginFill("#323232").beginStroke().moveTo(1.4,4.3).lineTo(1.4,-0.5).curveTo(1.4,-2,-0,-2).curveTo(-0.6,-2,-1,-1.6).curveTo(-1.4,-1.2,-1.4,-0.5).lineTo(-1.4,4.3).lineTo(-4,4.3).lineTo(-4,-4.1).lineTo(-1.5,-4.1).lineTo(-1.5,-3.2).curveTo(-1.2,-3.7,-0.5,-4.1).curveTo(0.2,-4.3,0.9,-4.3).curveTo(2.4,-4.3,3.2,-3.4).curveTo(4,-2.5,4,-1).lineTo(4,4.3).closePath();
	this.shape_33.setTransform(-36.175,-18.625);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.beginFill("#323232").beginStroke().moveTo(3.2,6).lineTo(2.3,3.6).lineTo(-2.4,3.6).lineTo(-3.2,6).lineTo(-6.1,6).lineTo(-1.5,-6).lineTo(1.6,-6).lineTo(6.1,6).closePath().moveTo(1.4,1.1).lineTo(0,-3).lineTo(-1.5,1.1).lineTo(1.4,1.1).closePath();
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#323232").beginStroke().moveTo(-3.5,6.6).lineTo(-1.4,1.7).lineTo(-5.3,-6.6).lineTo(-2.1,-6.6).lineTo(0.2,-1.5).lineTo(2.3,-6.6).lineTo(5.4,-6.6).lineTo(-0.5,6.6).closePath();
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#323232").beginStroke().moveTo(-1.4,6.9).lineTo(-1.4,-6.9).lineTo(1.5,-6.9).lineTo(1.5,6.9).closePath();
	this.shape_2.setTransform(52.45,11.075);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#323232").beginStroke().moveTo(-3.5,4.2).curveTo(-4.3,3.3,-4.3,2.2).curveTo(-4.3,0.9,-3.5,0.2).curveTo(-2.8,-0.5,-1.5,-0.7).lineTo(0.7,-1.1).curveTo(1.4,-1.2,1.4,-1.7).curveTo(1.4,-2.1,1,-2.4).curveTo(0.6,-2.7,-0,-2.7).curveTo(-0.7,-2.7,-1.2,-2.3).curveTo(-1.6,-1.9,-1.6,-1.3).lineTo(-4.1,-1.9).curveTo(-4,-3,-3.1,-3.9).curveTo(-1.9,-5,0,-5).curveTo(2.2,-5,3.3,-3.9).curveTo(4.2,-3,4.2,-1.3).lineTo(4.2,3.3).curveTo(4.2,4.2,4.3,4.7).lineTo(1.7,4.7).lineTo(1.6,3.7).curveTo(0.8,5,-1.1,5).curveTo(-2.5,5,-3.5,4.2).closePath().moveTo(-0.4,0.9).curveTo(-1.5,1.1,-1.5,1.9).curveTo(-1.5,2.9,-0.3,2.9).curveTo(1.4,2.9,1.4,1).lineTo(1.4,0.7).closePath();
	this.shape_3.setTransform(44.425,13.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#323232").beginStroke().moveTo(-3,4.8).lineTo(-3,-4.7).lineTo(-0.2,-4.7).lineTo(-0.2,-3.4).curveTo(0.4,-4.8,2.2,-4.8).lineTo(3,-4.7).lineTo(3,-1.8).lineTo(2.1,-1.9).curveTo(1.2,-1.9,0.5,-1.3).curveTo(-0.1,-0.7,-0.1,0.7).lineTo(-0.1,4.8).closePath();
	this.shape_4.setTransform(36,13.175);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#323232").beginStroke().moveTo(-3.6,3.7).curveTo(-4.5,2.7,-4.5,1.1).lineTo(-4.5,-4.8).lineTo(-1.6,-4.8).lineTo(-1.6,0.5).curveTo(-1.6,1.3,-1.2,1.7).curveTo(-0.8,2.2,-0.1,2.2).curveTo(0.6,2.2,1.1,1.7).curveTo(1.5,1.3,1.5,0.6).lineTo(1.5,-4.8).lineTo(4.4,-4.8).lineTo(4.4,2.9).lineTo(4.5,4.6).lineTo(1.7,4.6).lineTo(1.6,3.7).curveTo(0.9,4.8,-0.9,4.8).curveTo(-2.6,4.8,-3.6,3.7).closePath();
	this.shape_5.setTransform(26.125,13.325);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#323232").beginStroke().moveTo(-0.7,5.4).curveTo(-1.5,4.6,-1.5,3.2).lineTo(-1.5,-0.9).lineTo(-3.2,-0.9).lineTo(-3.2,-3.4).lineTo(-2.7,-3.4).curveTo(-1.2,-3.4,-1.2,-5).lineTo(-1.2,-6.2).lineTo(1.3,-6.2).lineTo(1.3,-3.4).lineTo(3.2,-3.4).lineTo(3.2,-0.9).lineTo(1.3,-0.9).lineTo(1.3,2.6).curveTo(1.3,3.6,2.4,3.6).lineTo(3.1,3.5).lineTo(3.1,5.9).curveTo(2.6,6.2,1.7,6.2).curveTo(0.2,6.2,-0.7,5.4).closePath();
	this.shape_6.setTransform(16.6,11.925);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#323232").beginStroke().moveTo(-3.5,4.2).curveTo(-4.3,3.3,-4.3,2.2).curveTo(-4.3,0.9,-3.5,0.2).curveTo(-2.8,-0.5,-1.5,-0.7).lineTo(0.7,-1.1).curveTo(1.4,-1.2,1.4,-1.7).curveTo(1.4,-2.1,1,-2.4).curveTo(0.6,-2.7,-0,-2.7).curveTo(-0.7,-2.7,-1.2,-2.3).curveTo(-1.6,-1.9,-1.6,-1.3).lineTo(-4.1,-1.9).curveTo(-4,-3,-3.1,-3.9).curveTo(-1.9,-5,0,-5).curveTo(2.2,-5,3.3,-3.9).curveTo(4.2,-3,4.2,-1.3).lineTo(4.2,3.3).curveTo(4.2,4.2,4.3,4.7).lineTo(1.7,4.7).lineTo(1.6,3.7).curveTo(0.8,5,-1.1,5).curveTo(-2.5,5,-3.5,4.2).closePath().moveTo(-0.4,0.9).curveTo(-1.5,1.1,-1.5,1.9).curveTo(-1.5,2.9,-0.3,2.9).curveTo(1.4,2.9,1.4,1).lineTo(1.4,0.7).closePath();
	this.shape_7.setTransform(7.875,13.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#323232").beginStroke().moveTo(1.6,4.8).lineTo(1.6,-0.6).curveTo(1.6,-2.2,-0,-2.2).curveTo(-0.7,-2.2,-1.1,-1.8).curveTo(-1.5,-1.3,-1.6,-0.6).lineTo(-1.6,4.8).lineTo(-4.5,4.8).lineTo(-4.5,-4.6).lineTo(-1.7,-4.6).lineTo(-1.7,-3.5).curveTo(-1.3,-4.2,-0.5,-4.5).curveTo(0.2,-4.9,1,-4.8).curveTo(2.7,-4.8,3.6,-3.7).curveTo(4.5,-2.7,4.5,-1.1).lineTo(4.5,4.8).closePath();
	this.shape_8.setTransform(-2.75,13.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#323232").beginStroke().moveTo(-3,3.9).curveTo(-3.8,3.1,-3.9,2).lineTo(-1.4,1.6).curveTo(-1.4,2.1,-1,2.5).curveTo(-0.6,2.9,0.1,2.9).curveTo(1.2,2.9,1.2,2.1).curveTo(1.2,1.5,0.2,1.3).lineTo(-0.9,1).curveTo(-3.7,0.4,-3.7,-1.9).curveTo(-3.7,-3.2,-2.6,-4.1).curveTo(-1.6,-5,-0,-5).curveTo(1.8,-5,2.8,-4).curveTo(3.6,-3.2,3.7,-2.2).lineTo(1.3,-1.8).curveTo(1.2,-2.9,-0,-2.9).curveTo(-0.4,-2.9,-0.7,-2.7).curveTo(-1,-2.5,-1,-2.1).curveTo(-1,-1.5,-0.3,-1.4).lineTo(1,-1.1).curveTo(2.4,-0.9,3.1,-0).curveTo(3.9,0.7,3.9,1.8).curveTo(3.9,3.1,2.9,4).curveTo(1.9,5,0.1,5).curveTo(-1.9,5,-3,3.9).closePath();
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#323232").beginStroke().moveTo(4.5,4.9).lineTo(4.5,-0.6).curveTo(4.5,-2.2,3.1,-2.2).curveTo(2.3,-2.2,1.9,-1.7).curveTo(1.5,-1.2,1.5,-0.6).lineTo(1.5,4.9).lineTo(-1.3,4.9).lineTo(-1.3,-0.6).curveTo(-1.3,-2.2,-2.9,-2.2).curveTo(-3.6,-2.2,-4,-1.7).curveTo(-4.4,-1.2,-4.5,-0.6).lineTo(-4.5,4.9).lineTo(-7.4,4.9).lineTo(-7.4,-4.6).lineTo(-4.6,-4.6).lineTo(-4.6,-3.5).curveTo(-4.2,-4.1,-3.4,-4.5).curveTo(-2.6,-4.9,-1.9,-4.9).curveTo(0.2,-4.9,0.9,-3.4).curveTo(1.9,-4.9,3.9,-4.9).curveTo(5.3,-4.9,6.3,-4).curveTo(7.4,-3,7.4,-1.2).lineTo(7.4,4.9).closePath();
	this.shape_11.setTransform(-41.05,13.075);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#323232").beginStroke().moveTo(-3.5,3.6).curveTo(-5,2.2,-5,-0).curveTo(-5,-2.2,-3.5,-3.6).curveTo(-2.1,-5,-0,-5).curveTo(2.2,-5,3.6,-3.6).curveTo(5,-2.2,5,-0).curveTo(5,2.2,3.6,3.6).curveTo(2.2,5,-0,5).curveTo(-2.1,5,-3.5,3.6).closePath().moveTo(-1.5,-1.8).curveTo(-2.1,-1.1,-2.1,-0).curveTo(-2.1,1.1,-1.5,1.8).curveTo(-0.9,2.4,-0,2.4).curveTo(0.9,2.4,1.5,1.8).curveTo(2.1,1.1,2.1,-0).curveTo(2.1,-1.1,1.5,-1.8).curveTo(0.9,-2.3,-0,-2.3).curveTo(-0.9,-2.3,-1.5,-1.8).closePath();
	this.shape_12.setTransform(-55.25,13.225);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#323232").beginStroke().moveTo(-3.3,3.6).curveTo(-4.8,2.2,-4.8,0).curveTo(-4.8,-2.2,-3.3,-3.6).curveTo(-1.9,-5,0.2,-5).curveTo(2,-5,3.3,-4).curveTo(4.4,-3.1,4.7,-1.7).lineTo(2.1,-0.9).curveTo(1.7,-2.3,0.2,-2.3).curveTo(-0.7,-2.3,-1.3,-1.7).curveTo(-1.9,-1.1,-1.9,0).curveTo(-1.9,1.1,-1.3,1.7).curveTo(-0.7,2.4,0.3,2.4).curveTo(1.8,2.4,2.2,0.9).lineTo(4.8,1.7).curveTo(4.4,3.1,3.3,4).curveTo(2.1,5,0.3,5).curveTo(-1.8,5,-3.3,3.6).closePath();
	this.shape_13.setTransform(-66.125,13.225);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#323232").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_14.setTransform(41.075,-8.825);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#323232").beginStroke().moveTo(-1.7,6.9).lineTo(-1.7,-0).lineTo(-3.3,-0).lineTo(-3.3,-2.5).lineTo(-1.7,-2.5).lineTo(-1.7,-3.3).curveTo(-1.8,-5,-0.8,-6).curveTo(0.2,-7,1.9,-7).curveTo(2.8,-7,3.3,-6.8).lineTo(3.3,-4.4).lineTo(2.4,-4.5).curveTo(1.1,-4.5,1.1,-3.2).lineTo(1.1,-2.5).lineTo(3.2,-2.5).lineTo(3.2,-0).lineTo(1.1,-0).lineTo(1.1,6.9).closePath();
	this.shape_15.setTransform(32.35,-11.05);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#323232").beginStroke().moveTo(-1.5,7).lineTo(-1.5,-2.5).lineTo(1.4,-2.5).lineTo(1.4,7).closePath().moveTo(-1.2,-4.1).curveTo(-1.7,-4.7,-1.7,-5.4).curveTo(-1.7,-6,-1.2,-6.5).curveTo(-0.7,-7,-0,-7).curveTo(0.7,-7,1.2,-6.5).curveTo(1.7,-6,1.7,-5.4).curveTo(1.7,-4.7,1.2,-4.1).curveTo(0.7,-3.7,-0,-3.7).curveTo(-0.7,-3.7,-1.2,-4.1).closePath();
	this.shape_16.setTransform(26.225,-11.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#323232").beginStroke().moveTo(-1.4,6.9).lineTo(-1.4,-6.9).lineTo(1.4,-6.9).lineTo(1.4,6.9).closePath();
	this.shape_17.setTransform(20.8,-10.975);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#323232").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_18.setTransform(8.175,-8.825);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.beginFill("#323232").beginStroke().moveTo(-3,4.8).lineTo(-3,-4.7).lineTo(-0.2,-4.7).lineTo(-0.2,-3.4).curveTo(0.5,-4.8,2.3,-4.8).lineTo(3,-4.7).lineTo(3,-1.8).lineTo(2.1,-1.9).curveTo(1.2,-1.9,0.5,-1.3).curveTo(-0.1,-0.7,-0.1,0.7).lineTo(-0.1,4.8).closePath();
	this.shape_19.setTransform(-0.55,-8.875);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.beginFill("#323232").beginStroke().moveTo(-3.3,3.7).curveTo(-4.7,2.3,-4.7,-0).curveTo(-4.7,-2.2,-3.3,-3.7).curveTo(-1.9,-5,-0,-5).curveTo(2.2,-5,3.4,-3.7).curveTo(4.7,-2.4,4.7,-0.2).lineTo(4.6,0.7).lineTo(-1.9,0.7).curveTo(-1.9,1.5,-1.3,2).curveTo(-0.6,2.6,0.2,2.6).curveTo(1.7,2.6,2.1,1.3).lineTo(4.5,2).curveTo(4.2,3.3,3.1,4.1).curveTo(1.9,5,0.2,5).curveTo(-1.9,5,-3.3,3.7).closePath().moveTo(1.9,-1.1).curveTo(1.9,-1.8,1.5,-2.2).curveTo(1,-2.7,0,-2.7).curveTo(-0.8,-2.7,-1.4,-2.2).curveTo(-1.8,-1.7,-1.9,-1.1).lineTo(1.9,-1.1).lineTo(1.9,-1.1).closePath();
	this.shape_20.setTransform(-10.075,-8.825);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.beginFill("#323232").beginStroke().moveTo(1.6,6.9).lineTo(1.6,1.4).curveTo(1.6,-0.2,0,-0.2).curveTo(-0.6,-0.2,-1.1,0.2).curveTo(-1.5,0.7,-1.6,1.3).lineTo(-1.6,6.9).lineTo(-4.5,6.9).lineTo(-4.5,-6.9).lineTo(-1.6,-6.9).lineTo(-1.6,-2).curveTo(-0.7,-2.8,0.9,-2.8).curveTo(2.6,-2.8,3.6,-1.7).curveTo(4.4,-0.7,4.4,0.9).lineTo(4.4,6.9).closePath();
	this.shape_21.setTransform(-21,-10.975);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.beginFill("#323232").beginStroke().moveTo(2.9,6.7).lineTo(0,-2.2).lineTo(-2.8,6.7).lineTo(-6,6.7).lineTo(-9.7,-6.7).lineTo(-6.5,-6.7).lineTo(-4.3,1.9).lineTo(-1.5,-6.7).lineTo(1.6,-6.7).lineTo(4.4,1.9).lineTo(6.6,-6.7).lineTo(9.7,-6.7).lineTo(6,6.7).closePath();
...
(lib.FHLeaderboard_728x90 = function(mode,startPosition,loop) {
	...
	this.shape_139.graphics.beginFill("#FF6400").beginStroke().moveTo(-2,2.4).curveTo(-3,1.4,-3,-0.1).curveTo(-2.9,-1.5,-2.1,-2.3).curveTo(-1.2,-3.3,-0,-3.2).curveTo(1.4,-3.3,2.1,-2.3).curveTo(3,-1.5,3,-0.1).lineTo(2.9,0.4).lineTo(-1.7,0.4).curveTo(-1.7,1.1,-1.2,1.6).curveTo(-0.6,2.2,0.2,2.2).curveTo(1.4,2.2,1.9,0.9).lineTo(2.9,1.3).curveTo(2.6,2.1,2,2.7).curveTo(1.1,3.2,0.2,3.2).curveTo(-1.2,3.2,-2,2.4).closePath().moveTo(1.7,-0.6).curveTo(1.6,-1.3,1.2,-1.8).curveTo(0.8,-2.2,-0,-2.2).curveTo(-0.7,-2.2,-1.2,-1.7).curveTo(-1.6,-1.3,-1.6,-0.6).lineTo(1.7,-0.6).lineTo(1.7,-0.6).closePath();
	this.shape_139.setTransform(687.25,29.6);

	this.shape_140 = new cjs.Shape();
	this.shape_140.graphics.beginFill("#FF6400").beginStroke().moveTo(-1.7,3.1).lineTo(-1.7,-3).lineTo(-0.5,-3).lineTo(-0.5,-1.9).curveTo(0,-3.1,1.3,-3.1).lineTo(1.7,-3.1).lineTo(1.7,-1.8).lineTo(1.2,-1.8).curveTo(-0.5,-1.9,-0.5,0.1).lineTo(-0.5,3.1).closePath();
	this.shape_140.setTransform(681.9,29.55);

	this.shape_141 = new cjs.Shape();
	this.shape_141.graphics.beginFill("#FF6400").beginStroke().moveTo(-2.2,2.3).curveTo(-3.1,1.4,-3.1,0).curveTo(-3.1,-1.4,-2.2,-2.3).curveTo(-1.4,-3.3,0,-3.2).curveTo(1.4,-3.3,2.3,-2.3).curveTo(3.1,-1.4,3.1,0).curveTo(3.1,1.4,2.3,2.3).curveTo(1.4,3.2,0,3.2).curveTo(-1.4,3.2,-2.2,2.3).closePath().moveTo(-1.3,-1.6).curveTo(-1.9,-1.1,-1.9,0).curveTo(-1.9,1,-1.3,1.6).curveTo(-0.8,2.1,0,2.2).curveTo(0.8,2.1,1.3,1.6).curveTo(1.9,1,1.9,0).curveTo(1.9,-1.1,1.3,-1.6).curveTo(0.8,-2.2,0,-2.2).curveTo(-0.8,-2.2,-1.3,-1.6).closePath();
	this.shape_141.setTransform(675.625,29.6);

	this.shape_142 = new cjs.Shape();
	this.shape_142.graphics.beginFill("#FF6400").beginStroke().moveTo(3.3,3.2).lineTo(3.3,-0.7).curveTo(3.3,-2.1,2,-2.1).curveTo(1.4,-2.1,1,-1.7).curveTo(0.6,-1.2,0.6,-0.5).lineTo(0.6,3.2).lineTo(-0.6,3.2).lineTo(-0.6,-0.7).curveTo(-0.6,-2.1,-1.9,-2.1).curveTo(-2.5,-2.1,-2.9,-1.7).curveTo(-3.3,-1.2,-3.3,-0.5).lineTo(-3.3,3.2).lineTo(-4.5,3.2).lineTo(-4.5,-3).lineTo(-3.3,-3).lineTo(-3.3,-2.1).curveTo(-2.8,-3.2,-1.5,-3.1).curveTo(-0.2,-3.1,0.4,-2).curveTo(1,-3.1,2.4,-3.1).curveTo(3.2,-3.2,3.9,-2.6).curveTo(4.5,-2,4.5,-0.8).lineTo(4.5,3.2).closePath();
	this.shape_142.setTransform(666.7,29.5);

	this.shape_143 = new cjs.Shape();
	this.shape_143.graphics.beginFill("#FF6400").beginStroke().moveTo(-1.7,3.1).lineTo(-1.7,-3).lineTo(-0.5,-3).lineTo(-0.5,-1.9).curveTo(0,-3.1,1.3,-3.1).lineTo(1.7,-3.1).lineTo(1.7,-1.8).lineTo(1.2,-1.8).curveTo(-0.5,-1.9,-0.5,0.1).lineTo(-0.5,3.1).closePath();
	this.shape_143.setTransform(656.15,29.55);

	this.shape_144 = new cjs.Shape();
	this.shape_144.graphics.beginFill("#FF6400").beginStroke().moveTo(-2.2,2.3).curveTo(-3.1,1.4,-3.1,0).curveTo(-3.1,-1.4,-2.2,-2.3).curveTo(-1.4,-3.3,0,-3.2).curveTo(1.4,-3.3,2.3,-2.3).curveTo(3.1,-1.4,3.1,0).curveTo(3.1,1.4,2.3,2.3).curveTo(1.4,3.2,0,3.2).curveTo(-1.4,3.2,-2.2,2.3).closePath().moveTo(-1.3,-1.6).curveTo(-1.9,-1.1,-1.9,0).curveTo(-1.9,1,-1.3,1.6).curveTo(-0.8,2.1,0,2.2).curveTo(0.8,2.1,1.3,1.6).curveTo(1.9,1,1.9,0).curveTo(1.9,-1.1,1.3,-1.6).curveTo(0.8,-2.2,0,-2.2).curveTo(-0.8,-2.2,-1.3,-1.6).closePath();
	this.shape_144.setTransform(649.875,29.6);

	this.shape_145 = new cjs.Shape();
	this.shape_145.graphics.beginFill("#FF6400").beginStroke().moveTo(-0.8,4.6).lineTo(-0.8,-0.4).lineTo(-1.9,-0.4).lineTo(-1.9,-1.5).lineTo(-0.8,-1.5).lineTo(-0.8,-2.5).curveTo(-0.8,-3.5,-0.2,-4.1).curveTo(0.4,-4.6,1.2,-4.6).curveTo(1.8,-4.6,1.9,-4.5).lineTo(1.9,-3.4).lineTo(1.4,-3.5).curveTo(0.4,-3.5,0.4,-2.5).lineTo(0.4,-1.5).lineTo(1.9,-1.5).lineTo(1.9,-0.4).lineTo(0.4,-0.4).lineTo(0.4,4.6).closePath();
	this.shape_145.setTransform(644.125,28.025);

	this.shape_146 = new cjs.Shape();
	this.shape_146.graphics.beginFill("#FF6400").beginStroke().moveTo(1.3,4.6).lineTo(-0.7,1.9).lineTo(-1.6,2.7).lineTo(-1.6,4.6).lineTo(-2.8,4.6).lineTo(-2.8,-4.6).lineTo(-1.6,-4.6).lineTo(-1.6,1.2).lineTo(1.1,-1.5).lineTo(2.7,-1.5).lineTo(0.1,1).lineTo(2.8,4.6).closePath();
	this.shape_146.setTransform(636.025,28.05);

	this.shape_147 = new cjs.Shape();
	this.shape_147.graphics.beginFill("#FF6400").beginStroke().moveTo(-2,2.3).curveTo(-2.9,1.4,-2.9,0).curveTo(-2.9,-1.5,-2,-2.3).curveTo(-1.2,-3.3,0.2,-3.2).curveTo(1.3,-3.2,2,-2.7).curveTo(2.7,-2.1,2.9,-1.3).lineTo(1.8,-0.9).curveTo(1.5,-2.2,0.2,-2.2).curveTo(-0.6,-2.1,-1.1,-1.6).curveTo(-1.7,-1,-1.7,0).curveTo(-1.7,1,-1.1,1.6).curveTo(-0.6,2.1,0.2,2.2).curveTo(1.5,2.2,1.9,0.9).lineTo(2.9,1.4).curveTo(2.7,2.1,2,2.6).curveTo(1.3,3.2,0.2,3.2).curveTo(-1.2,3.2,-2,2.3).closePath();
	this.shape_147.setTransform(629.025,29.6);

	this.shape_148 = new cjs.Shape();
	this.shape_148.graphics.beginFill("#FF6400").beginStroke().moveTo(-0.6,4.7).lineTo(-0.6,-1.5).lineTo(0.6,-1.5).lineTo(0.6,4.7).closePath().moveTo(-0.6,-3.2).curveTo(-0.9,-3.5,-0.9,-3.8).curveTo(-0.9,-4.2,-0.6,-4.4).curveTo(-0.4,-4.7,0,-4.7).curveTo(0.3,-4.7,0.6,-4.4).curveTo(0.8,-4.2,0.8,-3.8).curveTo(0.8,-3.5,0.6,-3.2).curveTo(0.3,-3,0,-3).curveTo(-0.4,-3,-0.6,-3.2).closePath();
	this.shape_148.setTransform(624.05,28);

	this.shape_149 = new cjs.Shape();
	this.shape_149.graphics.beginFill("#FF6400").beginStroke().moveTo(-0.6,4.6).lineTo(-0.6,-4.6).lineTo(0.6,-4.6).lineTo(0.6,4.6).closePath();
	this.shape_149.setTransform(620.95,28.05);

	this.shape_150 = new cjs.Shape();
	this.shape_150.graphics.beginFill("#FF6400").beginStroke().moveTo(-2.8,3.4).curveTo(-4.2,2.1,-4.3,0).curveTo(-4.2,-2.2,-2.8,-3.5).curveTo(-1.5,-4.7,0.2,-4.7).curveTo(1.7,-4.7,2.8,-3.9).curveTo(3.9,-3.2,4.2,-1.9).lineTo(3,-1.4).curveTo(2.5,-3.6,0.2,-3.6).curveTo(-1.1,-3.5,-1.9,-2.7).curveTo(-2.9,-1.7,-2.9,0).curveTo(-2.9,1.6,-1.9,2.6).curveTo(-1.1,3.6,0.2,3.5).curveTo(1.3,3.5,2.1,3).curveTo(2.8,2.3,3.1,1.4).lineTo(4.3,1.8).curveTo(3.8,3.1,2.8,3.9).curveTo(1.7,4.7,0.2,4.7).curveTo(-1.6,4.7,-2.8,3.4).closePath();
	this.shape_150.setTransform(614.65,28.15);

	this.shape_151 = new cjs.Shape();
	this.shape_151.graphics.beginFill().beginStroke("#FF6400").setStrokeStyle(1.7,1,1).moveTo(-40,-10).lineTo(40,-10).curveTo(44.1,-10,47.1,-7.1).curveTo(50,-4.2,50,0).curveTo(50,4.1,47.1,7).curveTo(44.1,10,40,10).lineTo(-40,10).curveTo(-44.2,10,-47.1,7).curveTo(-50,4.1,-50,0).curveTo(-50,-4.2,-47.1,-7.1).curveTo(-44.1,-10,-40,-10).closePath();
	this.shape_151.setTransform(651.025,28.675);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_151},{t:this.shape_150},{t:this.shape_149},{t:this.shape_148},{t:this.shape_147},{t:this.shape_146},{t:this.shape_145},{t:this.shape_144},{t:this.shape_143},{t:this.shape_142},{t:this.shape_141},{t:this.shape_140},{t:this.shape_139}]}).wait(285));

	// BKG
	this.shape_152 = new cjs.Shape();
	this.shape_152.graphics.beginFill("#D5D1CA").beginStroke().moveTo(-364,45).lineTo(-364,-45).lineTo(364,-45).lineTo(364,45).closePath();
	this.shape_152.setTransform(364,45);
